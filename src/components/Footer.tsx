      ...
      <div className="mx-auto grid max-w-6xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-3">
        <div>
          ...
          <nav aria-label="Social media" className="mt-6 flex flex-col gap-2">
            <a
              ...
              className="inline-flex min-h-14 items-center gap-3 text-lg font-semibold underline underline-offset-4"
            >
        ...
        <div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 inline-flex min-h-14 items-center text-lg font-semibold underline underline-offset-4"
          >
            Get Directions
